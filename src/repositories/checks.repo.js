...
// RETIRADO (Checks Hardening C2): createCheckPoint (alta de CheckPoint por datos del cliente) fue
// ELIMINADO junto con POST /checks. La creación autoritativa de los 4 CheckPoints es interna del backend
// y vive en ensureCheckPointsTx (authorize.repo), dentro de la transacción que aprueba el permiso,
// idempotente y respaldada por UNIQUE(IdPermission, IdPoint, Accion) (mig 014). No reintroducir una
// escritura de CheckPoints accesible fuera de ese flujo.
